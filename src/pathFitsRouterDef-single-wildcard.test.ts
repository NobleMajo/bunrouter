...
describe("pathFitsRouterDef with single wildcards", () => {
  ...
  it("2 parts on wildcard should result in false", () => {
    expect(pathFitsRouterDef(["part1", "part2"], ["*"])).toBe(false)
  })

  it("3 parts on wildcard should result in false", () => {
    expect(pathFitsRouterDef(["part1", "part2", "part3"], ["*"])).toBe(false)
  })

  it("4 parts on wildcard should result in false", () => {
    expect(pathFitsRouterDef(["part1", "part2", "part3", "part4"], ["*"])).toBe(false)
  })

  it("1 part on 2 wildcards should result in false", () => {
    expect(pathFitsRouterDef(["part1"], ["*", "*"])).toBe(false)
  })
  ...
  it("1 part on 1 part and 1 wildcard should result in false", () => {
    expect(pathFitsRouterDef(["part1"], ["part1", "*"])).toBe(false)
  })

  it("2 parts on 1 part and 1 wildcard should result in [part2]", () => {
    expect(pathFitsRouterDef(["part1", "part2"], ["part1", "*"])).toEqual(["part2"])
  })

  it("3 parts on 1 part and 1 wildcard should result in false", () => {
    expect(pathFitsRouterDef(["part1", "part2", "part3"], ["part1", "*"])).toBe(false)
  })

  it("4 parts on 1 part and 1 wildcard should result in false", () => {
    expect(pathFitsRouterDef(["part1", "part2", "part3", "part4"], ["part1", "*"])).toBe(false)
  })
  ...
  it("2 parts on 1 part and 2 wildcards should result in false", () => {
    expect(pathFitsRouterDef(["part1", "part2"], ["part1", "*", "*"])).toBe(false)
  })

  it("3 parts on 1 part and 2 wildcards should result in [part2, part3]", () => {
    expect(pathFitsRouterDef(["part1", "part2", "part3"], ["part1", "*", "*"])).toEqual(["part2", "part3"])
  })
