...
Bun does not have a built-in router, so I created this one without any dependencies.

Uses the speed of the bun for a simple, familiar and solid routing experience.
